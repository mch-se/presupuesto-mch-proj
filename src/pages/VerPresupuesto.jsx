...
export default function VerPresupuesto() {
  ...
  async function obtenerPresupuesto() {
    ...
    setHistorialEstados(historialCompleto);
    setLoading(false);
  }
    ...
    await supabase.from("presupuesto_estados").insert([
      {
        ...
        user_id: user.id,
        estado: "Edición",
        nota: `Presupuesto abierto para edición por ${aliasUsuario}`,
      },
    ]);
  ...
  function colorBotonEstado(estado) {
    ...
    if (estado === "Cerrado") return "bg-red-600 text-white";
    if (estado === "Enviado") return "bg-blue-600 text-white";
    if (estado === "Aprobado") return "bg-green-600 text-white";
    if (estado === "Finalizado") return "bg-purple-600 text-white";
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row lg:justify-between gap-5 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full lg:w-auto">
            <Link
              ...
              className="bg-orange-500 hover:bg-orange-600 px-5 py-4 rounded-2xl font-bold text-center"
            >
              Vista Previa PDF
            </Link>
            ...
            <Link
              to="/historial"
              className="bg-zinc-700 hover:bg-zinc-600 px-5 py-4 rounded-2xl font-bold text-center"
            >
              Volver
            </Link>
          </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-5 md:p-6 mb-6">
            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-3">
              {estados.map((estado) => (
                <button
                  ...
                  className={`px-4 py-3 rounded-2xl font-bold transition-all ${colorBotonEstado(
                    estado
                  )}`}
                >
                  {estado}
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-5 md:p-8 mb-6">
          ...
          <div className="hidden md:grid grid-cols-12 gap-4 mb-4 px-2 text-zinc-400 font-bold">
          ...
          <div className="space-y-4">
                ...
                <div className="md:hidden">
                  ...
                  <div className="grid grid-cols-3 gap-3 mt-4 text-sm">
                    <div className="bg-zinc-900 rounded-2xl p-3">
                      <p className="text-zinc-500">Cant.</p>
                      <p className="font-bold mt-1">{item.cantidad}</p>
                    </div>
                    ...
                    <div className="bg-zinc-900 rounded-2xl p-3">
                      ...
                      <p className="font-bold mt-1 text-orange-500 break-words">
                        {simbolo}
                        {Number(item.subtotal).toLocaleString()}
                      </p>
                    </div>
            ...
            {items.length === 0 && (
              <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6 text-zinc-500 text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              {historialEstados.map((estado) => (
                ...
                >
                  <div className="flex justify-between items-start gap-4">
                    <div>
                      ...
                      <p className="text-zinc-500 text-sm mt-1">
                        Por: {estado.alias_usuario}
                      </p>
                    </div>

                    <p className="text-zinc-400 text-sm text-right">
                      {new Date(
                        new Date(estado.created_at).getTime() -
                          3 * 60 * 60 * 1000
                  ...
                  {estado.nota && (
                    <p className="text-zinc-500 text-sm mt-3">{estado.nota}</p>
                  )}
                </div>
              ))}
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-5 md:p-8 h-fit">
            <div className="space-y-4 text-xl md:text-2xl">
              ...
              <div className="flex justify-between gap-4 text-3xl md:text-4xl font-bold text-orange-500 pt-6 border-t border-zinc-800">
                <span>Total</span>
